...
/**
 * This class represents the third Generalization Test page.
 *
 * @author Brandon Salines
 * @author Anthony Eannarino
 * @author Brian Faria
 */
public class GeneralizationTest3 extends ExaminerPage {
     ...
     */
    public GeneralizationTest3(Controller c) {
        super(c);
        initComponents();
        counter = 1;
        genCounter = 1;
        ...
        panelGeneralization3.setBackground(DEFAULT);
        this.setPreviousPage(GeneralizationTest2.ID);
        this.setNextPage(GeneralizationTest4.ID);
        this.setTest(panelGeneralization3);
    }
    ...
    private void initComponents() {
        ...
        panelGeneralization3 = new javax.swing.JPanel();
        ...
        panelGeneralization3.setBackground(Color.LIGHT_GRAY);
        panelGeneralization3.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        labelTitle.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        labelTitle.setText("Generalization Test");
        panelGeneralization3.add(labelTitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(96, 25, 220, 34));
        panelGeneralization3.add(spacer, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 200, 30, 20));

        errorLabel.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        errorLabel.setForeground(new java.awt.Color(204, 0, 0));
        panelGeneralization3.add(errorLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 620, 320, 30));

        genTestBtn1b.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bacf/pictures/GenTestpic3b.png"))); // NOI18N
        ...
        panelGeneralization3.add(genTestBtn1b, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 140, 140, 177));
        ...
        panelGeneralization3.add(reasonText, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 590, 410, 40));

        reasonlbl.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        reasonlbl.setText("Reasoning:");
        panelGeneralization3.add(reasonlbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 564, 110, 30));

        genTestBtn1c.setForeground(new java.awt.Color(240, 240, 240));
        genTestBtn1c.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bacf/pictures/GenTestpic3c.png"))); // NOI18N
        ...
        panelGeneralization3.add(genTestBtn1c, new org.netbeans.lib.awtextra.AbsoluteConstraints(399, 140, 140, 177));

        genTestBtn1a.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bacf/pictures/GenTestpic3a.png"))); // NOI18N
        ...
        panelGeneralization3.add(genTestBtn1a, new org.netbeans.lib.awtextra.AbsoluteConstraints(121, 140, 140, 177));

        genTestBtn1d.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bacf/pictures/GenTestpic3d.png"))); // NOI18N
        ...
        panelGeneralization3.add(genTestBtn1d, new org.netbeans.lib.awtextra.AbsoluteConstraints(121, 313, 140, 177));

        genTestBtn1e.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bacf/pictures/GenTestpic3e.png"))); // NOI18N
        ...
        panelGeneralization3.add(genTestBtn1e, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 313, 140, 177));

        genTestBtn1f.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bacf/pictures/GenTestpic3f.png"))); // NOI18N
        ...
        panelGeneralization3.add(genTestBtn1f, new org.netbeans.lib.awtextra.AbsoluteConstraints(399, 313, 140, 177));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(this);
        this.setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(panelGeneralization3, javax.swing.GroupLayout.PREFERRED_SIZE, 670, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(panelGeneralization3, javax.swing.GroupLayout.PREFERRED_SIZE, 656, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JPanel panelGeneralization3;
